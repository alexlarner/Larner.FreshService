function Connect-FSAPI {
	...
	process {
		...
		Write-PSFMessage "Setting necessary global variables: AllTicketFields & LastTicketFieldPullTime"
		# $script:AllTicketFields = Get-FSAllTicketFields -ForceRefresh
		# $script:LastTicketFieldPullTime = Get-Date
	}
}